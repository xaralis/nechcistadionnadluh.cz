...
class FAQImage(View):
    def get(self, *args, **kwargs):
        faq = get_object_or_404(models.FAQ, slug=self.request.resolver_match.kwargs.get("slug"))
        ...
        font = ImageFont.truetype(join(settings.BASE_DIR, 'thumbnails', 'Poppins-SemiBold.ttf'), font_size)
        ...
        font_character_width, font_character_height = font.getsize("M")[0], font.getsize("M")[1]
        padding = 32
