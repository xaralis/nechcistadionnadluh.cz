...
class SiteProfile(models.Model):
    ...
    votes_collected = models.PositiveIntegerField(
        verbose_name="Počet sesbíraných hlasů", null=False, blank=False, default=0
    )
    votes_targeted = models.PositiveIntegerField(
        verbose_name="Cílový počet sesbíraných hlasů",
        null=False,
        blank=False,
        default=8000,
    )
