"""
Django settings for nsnd project.
...
ADMINS = [("Filip Varecha", "filip.varecha@pirati.cz")]
...
ROOT_URLCONF = "nsnd.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, "nsnd", "templates"),],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "nsnd.context_processors.global_info",
                "nsnd.context_processors.votes",
            ],
        },
    },
]

WSGI_APPLICATION = "nsnd.wsgi.application"


# Database
# https://docs.djangoproject.com/en/2.2/ref/settings/#databases

DATABASE_DSN = os.environ.get("DATABASE_DSN", "postgresql://localhost:5432/nsnd")
...
# Markdown
MARKDOWNX_MARKDOWNIFY_FUNCTION = "nsnd.markdown.markdownify"
